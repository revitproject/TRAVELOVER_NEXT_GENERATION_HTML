...
function jquery() {
  return src("src/js/library/jquery-ui.1.13.3.js", { sourcemaps: false })
    .pipe(babel())
...
function jqueryTask() {
  return src("src/js/library/*.js", { ignore: "src/js/library/jquery-ui.1.13.3.js", sourcemaps: false })
    .pipe(babel())
...
function libraryConcatCss() {
  return src("src/js/library/css/*.css", { sourcemaps: false })
    .pipe(concat("librarycss.css", { newLine: ";" }))
    .pipe(dest("dist/resources/js/library/css"))
    .pipe(concat('librarycss.min.css'))
    .pipe(minifyCSS())
    .pipe(lineec())
    .pipe(dest("dist/resources/js/library/css"))
}
...
function watchTask() {
  ...
  watch(
    ...
    series(ejsTask, scssTask, jsTask, jqueryTask, libraryConcatCss, browsersyncReload)
  );
